...
#define RED_LED1_Pin GPIO_PIN_15
#define RED_LED1_GPIO_Port GPIOB
#define GREEN_LED1_Pin GPIO_PIN_8
#define GREEN_LED1_GPIO_Port GPIOD
#define LEDRESET_Pin GPIO_PIN_9
#define LEDRESET_GPIO_Port GPIOD
#define LDR2_Pin GPIO_PIN_10
#define LDR2_GPIO_Port GPIOD
#define LDR2_EXTI_IRQn EXTI15_10_IRQn
#define LDR1_Pin GPIO_PIN_11
#define LDR1_GPIO_Port GPIOD
